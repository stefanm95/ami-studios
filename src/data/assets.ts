...
export const brandAssets = {
  ...
  logoSlate: `${base}/ChatGPT Image Jun 15, 2026, 08_21_45 AM.png`,
  serviceStrip: `${base}/Gemini_Generated_Image_euk8edeuk8edeuk8.png`,
  textures: {
  ...
  hero: {
    ...
    fallbackImage: `${base}/ChatGPT Image Jun 15, 2026, 08_21_45 AM.png`,
    overlayTexture: `${base}/ambitious-studio-rick-barrett-jNOUEeCVKe4-unsplash.jpg`,
  },
  sections: {
    signature: `${base}/Gemini_Generated_Image_euk8edeuk8edeuk8.png`,
    services: `${base}/visualsofdana-IfsRTQu6Djk-unsplash.jpg`,
    ...
    booking: `${base}/ChatGPT Image Jun 15, 2026, 08_21_45 AM.png`,
    gallery: [
      `${base}/ambitious-studio-rick-barrett-jNOUEeCVKe4-unsplash.jpg`,
      ...
      `${base}/ChatGPT Image Jun 15, 2026, 08_21_45 AM.png`,
    ],
  },
  videos: {
